...
export default class App extends React.Component {
  ...
  displayCell = (row, col) => {
    ...
    // switches use cases, similar to if statement, easier to write
    // will setup a case by the value and return a given Icon component
    switch(value) {
  ...
  checkTie = () => {
    ...
    // 0 represents empty cell to click on, no 0's means no more cells
    for (let i in grid) {
      for (let j in grid[i]) {
      ...
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row' }}>
          <TouchableOpacity
            ...
            style={[styles.col, { borderLeftWidth: 0, borderBottomWidth: 0 }]}
          >
          ...
          <TouchableOpacity
            ...
            style={[styles.col, { borderRightWidth: 0, borderBottomWidth: 0 }]}
          >
